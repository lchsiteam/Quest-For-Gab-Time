...
create ()
{
    ...
    this.debugPlayerPos = this.add.text(100, 50, ((this.p.x/32).toFixed(2) + ", " + (this.p.y/32).toFixed(2)), { fontFamily: 'Verdana, "Comic Sans MS", Tahoma, serif' });
    this.debugPlayerObstacles = this.add.text(100, 100, (this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 2][Math.floor((this.p.x/32)) - 2] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 2][Math.floor((this.p.x/32)) - 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 2][Math.floor((this.p.x/32))] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 2][Math.floor((this.p.x/32)) + 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 2][Math.floor((this.p.x/32)) + 2] + "\n" + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 1][Math.floor((this.p.x/32)) - 2] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 1][Math.floor((this.p.x/32)) - 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 1][Math.floor((this.p.x/32))] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 1][Math.floor((this.p.x/32)) + 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 1][Math.floor((this.p.x/32)) + 2] + "\n" + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32))][Math.floor((this.p.x/32)) - 2] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32))][Math.floor((this.p.x/32)) - 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32))][Math.floor((this.p.x/32))] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32))][Math.floor((this.p.x/32)) + 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32))][Math.floor((this.p.x/32)) + 2] + "\n" + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 1][Math.floor((this.p.x/32)) - 2] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 1][Math.floor((this.p.x/32)) - 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 1][Math.floor((this.p.x/32))] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 1][Math.floor((this.p.x/32)) + 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 1][Math.floor((this.p.x/32)) + 2] + "\n" + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 2][Math.floor((this.p.x/32)) - 2] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 2][Math.floor((this.p.x/32)) - 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 2][Math.floor((this.p.x/32))] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 2][Math.floor((this.p.x/32)) + 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 2][Math.floor((this.p.x/32)) + 2] + "\n"), { fontFamily: 'Verdana, "Comic Sans MS", Tahoma, serif' });
...
update ()  {
    ...
    this.debugPlayerPos.setText(((this.p.x/32).toFixed(2) + ", " + (this.p.y/32).toFixed(2)));

    this.debugPlayerObstaclesTimer = this.debugPlayerObstaclesTimer - 1

    if (this.debugPlayerObstaclesTimer < 0) {
      this.debugPlayerObstacles.setText((this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 2][Math.floor((this.p.x/32)) - 2] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 2][Math.floor((this.p.x/32)) - 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 2][Math.floor((this.p.x/32))] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 2][Math.floor((this.p.x/32)) + 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 2][Math.floor((this.p.x/32)) + 2] + "\n" + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 1][Math.floor((this.p.x/32)) - 2] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 1][Math.floor((this.p.x/32)) - 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 1][Math.floor((this.p.x/32))] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 1][Math.floor((this.p.x/32)) + 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) - 1][Math.floor((this.p.x/32)) + 2] + "\n" + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32))][Math.floor((this.p.x/32)) - 2] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32))][Math.floor((this.p.x/32)) - 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32))][Math.floor((this.p.x/32))] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32))][Math.floor((this.p.x/32)) + 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32))][Math.floor((this.p.x/32)) + 2] + "\n" + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 1][Math.floor((this.p.x/32)) - 2] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 1][Math.floor((this.p.x/32)) - 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 1][Math.floor((this.p.x/32))] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 1][Math.floor((this.p.x/32)) + 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 1][Math.floor((this.p.x/32)) + 2] + "\n" + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 2][Math.floor((this.p.x/32)) - 2] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 2][Math.floor((this.p.x/32)) - 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 2][Math.floor((this.p.x/32))] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 2][Math.floor((this.p.x/32)) + 1] + this.PASSING_OBJ.obstacles[Math.floor((this.p.y/32)) + 2][Math.floor((this.p.x/32)) + 2] + "\n"));
    }
